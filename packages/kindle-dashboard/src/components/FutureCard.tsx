	...
	return (
		<article
			...
			<time dateTime={hourly.fxTime}
			      className="text-3xl">{formatTime(new Date(hourly.fxTime))}</time>

			{/* 天气图标 */}
			<i className={`qi-${hourly.icon} text-[150px]`} aria-label="天气图标"/>

			{/* 温度信息 */}
			<p className="font-bold text-5xl font-cabin-sketch ">
				{hourly.temp}°
			</p>

			{/* 天气描述 */}
			<p className="text-3xl">{hourly.text}</p>
		</article>
	);
}
